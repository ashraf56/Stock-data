...
Chartjs.register(CategoryScale, LinearScale,  PointElement,
  ...
  const MicrosoftMonth = () => {
    ...
    const url  =`https://api.polygon.io/v2/aggs/ticker/MSFT/range/1/month/2023-01-01/2023-10-31?adjusted=true&sort=asc&limit=1220&apiKey=${apikey}`
   ...
   <p className="text-5xl font-bold uppercase">{high} </p>
     <div className="card max-w-full mx-auto h-80">
