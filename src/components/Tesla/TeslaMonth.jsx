...
const TeslaMonth = () => {
    ...
    const url  =`https://api.polygon.io/v2/aggs/ticker/TSLA/range/1/month/2023-01-01/2023-10-31?adjusted=true&sort=asc&limit=1220&apiKey=${apikey}`
